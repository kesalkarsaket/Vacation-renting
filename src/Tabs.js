...
import TabNew1 from "./components/TabNew1";
import TabNew2 from "./components/TabNew2";
import TabNew3 from "./components/TabNew3";
    ...
    <>
      <Tabs>
            ...
            <TabList>
              <Tab className="tabImg md:pr-1 pr-0 ">
                <div>
                  ...
                  <div>
                    <label style={{ fontSize: "12px " }} className=" font-bold">
                      Tropical
                    </label>
                  </div>
                </div>
        ...
        <TabPanels>
          ...
          <TabPanel className="tab-content">
            {" "}
            <TabNew1 pushDown={toggle} />{" "}
          </TabPanel>
          <TabPanel className="tab-content">
            {" "}
            <TabNew2 pushDown={toggle} />{" "}
          </TabPanel>
          <TabPanel className="tab-content">
            {" "}
            <TabNew3 pushDown={toggle} />{" "}
          </TabPanel>
        </TabPanels>
      </Tabs>
    </>
