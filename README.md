<!-- The best air-bnb clone built using react and redux. comprising of the home page which offers you to choose the perfect stay from 100's of options. the navbar allowing the user to search for any destanation, select the dates and guests and thereby redirecting to the search results page. the user can sign in with his google account.
